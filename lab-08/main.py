...
class TestRunner:
    ...
    TEST_FILES = {
        'part1': 'examples/test_employee_part1.py',
        'part2': 'examples/test_employees_hierarchy_part2.py',
        'part3': 'examples/test_department_part3.py',
        'part4': 'examples/test_project_company_part4.py',
        'part5': 'examples/test_patterns_part5.py',
    }
    ...
    def find_test_files(pattern: str) -> list:
        ...
        :param pattern: шаблон поиска (например, 'examples/test_*_*.py')
        ...
        # Ищем все файлы которые начинаются на 'test_' и содержат '_'
        test_files = sorted([
            str(f) for f in examples_dir.glob('test_*_*.py')
        ])
    ...
    def run_all_tests(cls) -> None:
        ...
        test_files = cls.find_test_files('examples/test_*_*.py')
        
        if not test_files:
            print("❌ Тестовые файлы не найдены!")
            print("   Проверьте что папка examples/ содержит файлы test_*_*.py")
            return
    ...
    def show_help(cls) -> None:
        ...
        print("  ├── main.py")
        print("  ├── examples/")
        print("  │   ├── test_employee_part1.py")
        print("  │   ├── test_employees_hierarchy_part2.py")
        print("  │   ├── test_department_part3.py")
        print("  │   ├── test_project_company_part4.py")
        print("  │   └── test_patterns_part5.py")
        print("  ├── src/")
        print("  │   ├── base/")
        print("  │   ├── specialists/")
        print("  │   └── organization/")
